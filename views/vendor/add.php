...
<div class="container">
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="email" placeholder="Enter sp" name="slug">
        </div>
        <div class="form-group">
            <label for="phone">SDT:</label>
            <input type="number" class="form-control" id="phone" placeholder="Enter sdt" name="phone">
        </div>
